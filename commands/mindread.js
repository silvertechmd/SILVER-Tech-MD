const mindReads = [
  ...
  "*SILVER-Tech-Bot-V2* detected some deep thoughts 👁️✨",
  ...
  "*🧘 Energy level rising... SILVER-Tech-Bot-V2 reading deeper...*",
...
module.exports = {
  name: "mindread",
  description: "🧠 Reads the replied user's mind using SILVER-Tech-Bot-V2's deep AI magic ✨",
  category: "fun",
